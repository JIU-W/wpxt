...
public class UserInfoServiceImpl implements UserInfoService {
    ...
    public void register(String email, String nickName, String password, String emailCode) {
        ...
        userInfo.setTotalSpace(sysSettingsDto.getUserInitUseSpace() * Constants.MB);//5MB的空间
        //使用了的空间                                           //5*1024*1024=5242880字节
    ...
    public SessionWebUserDto login(String email, String password) {
        ...
        //拿登录的 qq邮箱 和 配置类里配置的管理员QQ邮箱对比(可以有多个) ，看登录的是不是管理员账号。
    ...
    public void changeUserSpace(String userId, Integer changeSpace) {
        ...
        //管理员是修改用户的总空间，不会修改用户的使用空间，所以设useSpace为null
        this.userInfoMapper.updateUserSpace(userId, null, space);
        //改完数据库中的 用户的使用空间 数据后，用数据库的信息改Redis信息
